...
import { fetchDebtServiceHistory, fetchLatestDebtService, fetchFinancialHistory } from './_helpers/guarantorDebtServiceTab.resolvers';
import { $debtServiceContainerDetails, $debtServiceContainerView } from './_helpers/guarantorDebtServiceTab.consts';
import { handleAddNew, handleEdit, handleDelete, handleViewDetails, handleCloseModal } from './_helpers/guarantorDebtServiceTab.events';
import GuarantorDebtServiceModalUpsert from './_components/GuarantorDebtServiceModalUpsert';
import GuarantorDebtServiceModalView from './_components/GuarantorDebtServiceModalView';
import GuarantorDebtServiceModalDelete from './_components/GuarantorDebtServiceModalDelete';

export function GuarantorDebtServiceTab() {
  ...
  return (
    <div>
      ...
      {/* Add/Edit Modal */}
      <GuarantorDebtServiceModalUpsert
        show={$debtServiceContainerView.value.activeModalKey === 'add' || $debtServiceContainerView.value.activeModalKey === 'edit'}
        onHide={handleCloseModal}
      />

      {/* Delete Modal */}
      <GuarantorDebtServiceModalDelete show={$debtServiceContainerView.value.activeModalKey === 'delete'} onHide={handleCloseModal} />

      {/* View Details Modal */}
      <GuarantorDebtServiceModalView
