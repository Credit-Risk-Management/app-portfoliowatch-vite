...
const DocumentsContainer = ({
  ...
  const $form = $submitPFSModalDetails;
    ...
    if (!pdfUrl && !hasStorageUrl) {
      return (
        <div>
          ...
          <FileUploader
            name="guarantorFinancialDocs"
            id="guarantor-financial-docs-input"
            ...
            <Row>
              ...
              <Col md={12} className="mb-16">
                <UniversalInput
                  ...
                  type="currency"
                  placeholder="$ USD"
                  value={$form.value.totalLiabilities}
