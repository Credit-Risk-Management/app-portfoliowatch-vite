...
const AddManagerModal = () => {
  ...
  const managerOptionsWithNone = helpers.getManagerOptionsWithNone(managers);
      ...
      <Row>
        <Col md={6} className="mb-16">
          ...
          <UniversalInput
            ...
            value={(() => {
              const currentValue = $relationshipManagersForm.value.manager_id || '';
              return managerOptionsWithNone.find((opt) => opt.value === currentValue) || managerOptionsWithNone[0];
            })()}
        ...
        <Col md={6} className="mb-16">
          ...
          <UniversalInput
            ...
            value={(() => {
              const currentValue = $relationshipManagersForm.value.is_active;
              return consts.STATUS_OPTIONS.find((opt) => opt.value === currentValue) || consts.STATUS_OPTIONS[0];
            })()}
