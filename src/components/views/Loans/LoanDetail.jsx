...
import { faFileAlt, faDownload, faTrash, faArrowLeft, faArrowRight, faEdit } from '@fortawesome/free-solid-svg-icons';
          ...
          <UniversalCard headerText="Covenants" bodyContainer="container-fluid" className="mt-16">
            <Row style={{ height: '250px' }}>
              <Col md={6}>
                ...
                <div>
                  <span className="text-info-300 fw-500 me-8">Actual:</span>
                ...
                <div className="mb-8">
                  <span className="text-info-300 fw-500 me-8">Covenant:</span>
            ...
            <div style={{ height: '250px' }}>
              <Row>
                ...
                <Col md={4} className="text-md-end">
                  <div className="text-info-100 fw-200 mt-16 mb-4">Industry Health Score</div>
